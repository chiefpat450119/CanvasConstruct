...
var _active_colour : Color = Color(1,0,0)
...
func _process(delta: float) -> void:
	...
	if Input.is_action_pressed("M1"):
		...
		if cell_under_mouse and !cell_under_mouse.modulate.is_equal_approx(_active_colour):
			cell_under_mouse.modulate = _active_colour
